...
parser.add_argument("-B", "--bines", help = "Number of bins for histogram", type = int, default=30)
args = parser.parse_args()

###### merge task3 output files
filenames = ['digested_t.masses', 'digested_a.masses', 'digested_l.masses','digested_e.masses']
...
print('Total number of proteins= ', nlines, file=t4_results)
...
print("Number of proteins",total_rows, file=t4_results)
...
# main histogram
plt.hist((task4_t['mass_to_charge'],task4_a['mass_to_charge'],task4_l['mass_to_charge'],task4_e['mass_to_charge']),bins=args.bines, label= ["Trypsin", "Endoproteinase Arg-C","Endoproteinase Lys-C","V8 proteinase"], stacked=False, alpha = 0.8,rwidth=0.8)
...
if args.analysis=="range":
    print("RANGE ANALYSIS RESULTS", file=t4_results)
    ...
    print("Number of proteins in range analysis is: ",total_rows, file=t4_results)
    # user defines range, not enzyme
    if args.enzyme == "":
        # user defines range, not enzyme, not sequence
        if args.sequence == "":
            print("Mass to charge for given range: ",data1['mass_to_charge'].mean()," Da", file = t4_results)
            print("Total number of peptides: ", data1['mass_to_charge'].count(), file = t4_results)
        ...
        # user defines range, not enzyme, yes sequence
            ...
            data11 = data1[cond3]
            print("Mass to charge for given range: ",data11['mass_to_charge'].mean()," Da", file = t4_results)
            print("Total number of peptides: ", data11['mass_to_charge'].count(), file = t4_results)
    ...
    # user defines range and enzyme
        ...
        if args.sequence == "":
            print("Mass to charge for given range: ",data2['mass_to_charge'].mean()," Da", file = t4_results)
            print("Total number of peptides: ", data2['mass_to_charge'].count(), file = t4_results)
        ...
        # user defines range, enzyme and sequence
            ...
            data21 = data2[cond5]
            print("Mass to charge for given range: ",data21['mass_to_charge'].mean()," Da", file = t4_results)
            print("Total number of peptides: ", data21['mass_to_charge'].count(), file = t4_results)
            print(data21, file = t4_results)


##### user defines full analysis (default)
else:
    ...
    if args.enzyme == "":
        ...
        if args.sequence == "":
            print("Mass to charge for data in default 1000Da-1500Da limits: ",task4dat['mass_to_charge'].mean()," Da", file = t4_results)
            print("Total number of peptides for data in default 1000Da-1500Da limits: ", task4dat['mass_to_charge'].count(), file = t4_results)
        ...
        # if user defines full, not enzyme, yes sequence
            ...
            print("Mass to charge for data in default 1000Da-1500Da limits ",data3['mass_to_charge'].mean()," Da", file = t4_results)
            print("Total number for data in default 1000Da-1500Da limits: ", data3['mass_to_charge'].count(), file = t4_results)
    ...
    # if user defines full and enzyme
        ...
        if args.sequence == "":
            print("Mass to charge for data in default 1000Da-1500Da limits: ",data4['mass_to_charge'].mean()," Da", file = t4_results)
            print("Total number of peptides for data in default 1000Da-1500Da limits: ", data4['mass_to_charge'].count(), file = t4_results)
        ...
        # if user defines full, enzyme and sequence
            ...
            data41 = data4[cond8]
            print("Mass to charge for data in default 1000Da-1500Da limits: ",data41['mass_to_charge'].mean()," Da", file = t4_results)
            print("Total number of peptides for data in default 1000Da-1500Da limits: ", data41['mass_to_charge'].count(), file = t4_results)
